...
function parseXLSX(data: string | ArrayBuffer): object[] {
    try {
        ...
        console.error("Ошибка при парсинге XLSX:", e);
        toast.error("Ошибка при парсинге XLSX");
        return [];
    }
}
...
function parseCSV(data: string): object[] {
    try {
        ...
        console.error("Ошибка при парсинге CSV:", e);
        toast.error("Ошибка при парсинге CSV");
        return [];
    }
}
